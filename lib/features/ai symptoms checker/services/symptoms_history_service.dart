...
class SymptomsHistoryService {
  ...
  // Get active symptoms (not resolved)
  ...
  Future<Map<String, dynamic>> getHealthInsights() async {
    ...
    final mostCommonSpecialist = specialistCount.entries
    ...
    } else if (severityBreakdown['low']! > severityBreakdown['mild']! + severityBreakdown['risky']!) {
